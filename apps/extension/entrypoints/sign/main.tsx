...
createRoot(root).render(<App engine={connectEngine()} body="extension-popup" host={extensionUiHost('extension-sign')} initialScreen="sign" initialParams={{ requestId: id }} />)
